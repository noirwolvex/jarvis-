...
- For unfamiliar apps or sites, prefer interaction_inspect then interaction_click/interaction_focus/interaction_type/interaction_hotkey. These universal tools auto-route managed Chrome to exact DOM/CDP and other foreground apps to Windows UIA/Rust. Do not manually choose a lower-level backend unless the universal semantic route cannot represent the target.
